...
async function setupPlanTemplates() {
    try {
        console.log('🚀 Starting PlanTemplates setup...');

        // 1. Tạo bảng PlanTemplates nếu chưa có
        ...
        // 3. Insert kế hoạch mẫu cho Basic Plan (PlanID = 1)
...
• Chuẩn bị cho những thử thách dài hạn', 14, 3)
        ...
        // 4. Insert kế hoạch mẫu cho Premium Plan (PlanID = 2)
...
• Chia sẻ kinh nghiệm để giúp người khác', 14, 4)
        ...
        // 5. Insert kế hoạch mẫu cho Pro Plan (PlanID = 3)
...
module.exports = { setupPlanTemplates }; 